...
def is_bootstrap_class(input_string):
    bootstrap_classes = {
        "container", "row", "col", "h1", "h2", "h3", "h4", "h5", "h6",
        "lead", "text-left", "text-right", "text-center", "text-justify", "text-nowrap",
        "btn", "btn-primary", "btn-secondary", "btn-success", "btn-danger",
        "btn-warning", "btn-info", "btn-light", "btn-dark",
        "form-group", "form-control", "form-check",
        "form-check-input", "form-check-label",
        "nav", "nav-item", "nav-link", "navbar", "navbar-brand", "navbar-toggler",
        ...
        "accordion-body", "accordion-button", "accordion-collapse", "accordion-flush", "accordion-header", "accordion-item",
        "collapsed",
    }

    bootstrap_prefixes = {
        "bs-", "bootstrap-", "btn-", "md:", "col-", "border-", "rounded-", "carousel-", "bg-", "link-", "d-", "dropdown-",
        "align-content-", "align-items-", "align-self-", "flex-", "justify-", "order-", "form-", "row-", "g-", "container-",
        "gap-", "gx-", "gy-", "offset-", "order-", "list-", "d-", "pe-", "shadow-", "modal-", "navbar-", "nav-", "float-",
        "position-", "start-", "sticky-", "progress-", "h-", "mh-", "w-", "m-", "me-", "ms-", "mt-", "mx-", "my-", "p-",
        "pb-", "pe-", "pl-", "ps-", "pt-", "px-", "py-", "table-", "font-", "text-", "display-", "fs-", "fw-", "lh-", "list-", "js-"
    }

    return input_string in bootstrap_classes or any(input_string.startswith(prefix) for prefix in bootstrap_prefixes)

def is_tailwind_class(class_name):
    tailwind_classes = [
        # Display
        "block", "inline", "inline-block", "hidden", "flex", "inline-flex",
        ...
        "font-bold", "font-semibold", "font-normal", "font-light", "italic",
        "text-left", "text-right", "text-center", "text-justify",

        # Background Colors
        "bg-transparent", "bg-black", "bg-white", "bg-gray-100", "bg-red-500",
        "bg-green-500", "bg-blue-500", "bg-yellow-500", "bg-purple-500",

        # Padding & Margin
        "p-4", "pt-2", "pr-3", "pb-4", "pl-5",
        "m-4", "mt-2", "mr-3", "mb-4", "ml-5",

        # Border
        "border", "border-solid", "border-gray-500", "border-t", "border-b", "border-r", "border-l",
        "border-2", "border-transparent", "rounded", "rounded-lg",

        # Width & Height
        "w-64", "h-32", "min-w-0", "min-h-0",

        # Other
        "shadow", "cursor-pointer", "transition", "ease-in-out", "duration-300",
    ]
...
def remove_extra_info(html):
    ...
    unwanted_tags = ['script', 'style', 'meta', 'link', 'iframe', 'svg', 'head', 'span', 'code']
    ...
    for tag in soup(recursive=True):
        ...
        extra_attributes = [attr for attr in tag.attrs if attr not in essential_attributes]
...
def main():
    #url = 'https://stackoverflow.com/questions/66955402/getting-all-the-html-code-from-a-website-that-is-using-react'
    url = "https://partners.dev.rappi.com/"
